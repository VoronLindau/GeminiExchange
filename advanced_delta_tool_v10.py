...
APP_VERSION = "v10.7 (Reporting Edition)"
...
# NEU: Generierung eines Word-Reports für die Änderungen
def generate_word_report():
    ...
    try:
        ...
        for i, b in enumerate(details, 1):
            ...
            # Bilder-Erkennung (prüft rohe XML-Tags vor der HTML-Formatierung)
            ...
            <script>
                ...
                function triggerReport() {
                    ...
                    fetch('/api/report').then(res => res.json()).then(data => {
                        ...
                        btn.textContent = "📊 Report (Word) erzeugen";
